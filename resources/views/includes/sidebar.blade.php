            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                         <a class="has-arrow waves-effect waves-dark" href="{{URL::to('admin/manageAssets')}}" aria-expanded="false">
                                <i class="mdi mdi-bank"></i>
                            <span class="hide-menu">Asset</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="app-calendar.html">Kelola Tipe Asset</a></li>
                                <li><a href="app-chat.html">Kelola Asset</a></li>
                                <li><a href="app-chat.html">Kelola Kategori Asset</a></li>
                            </ul>
                        </li>
