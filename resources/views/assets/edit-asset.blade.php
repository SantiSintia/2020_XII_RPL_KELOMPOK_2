...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="asset_name" type="text" value="{{$asset->ass_name}}" placeholder="Nama Aset" class="form-control" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select name="type_asset" class="form-control custom-select" required="">
                                   <option value="{{$asset->ast_id}}">{{$asset->ast_name}} </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select name="asset_origin" class="form-control custom-select">
                                   <option value="{{$asset->ori_id}}">{{$asset->ori_name}} </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="asset_year" required="" type="number" value="{{$asset->ass_year}}" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input name="asset_price" type="number" value="{{$asset->ass_price}}" class="form-control" placeholder="Harga" required="">
                            </div>
                        </div>
    ...
    <script >
        function myFunction() {
            ...
            if (x == "Elektronik") {
                document.getElementById("jk").innerHTML = '<div class="form-group row"><label class="control-label text-right col-md-3">bahan</label><div class="col-md-9"><input name="asd_inggridient" value="{{$asset->asd_inggridient}}" type="text" class="form-control" placeholder="Bahan"></div></div></div><div class="form-group row"><label class="control-label text-right col-md-3">Merk</label><div class="col-md-9"><input name="asd_merk" value="{{$asset->asd_merk}}" type="text" class="form-control" placeholder="Merk"></div></div></div><div class="form-group row"><label class="control-label text-right col-md-3">spesifikasi</label><div class="col-md-9"><input name="asd_spesification"value="{{$asset->asd_spesification}}" type="text" class="form-control" placeholder="Spesifikasi"></div></div></div><div class="form-group row"><label class="control-label text-right col-md-3">voltase</label><div class="col-md-9"><input name="asd_voltage" value="{{$asset->asd_voltage}}" type="text" class="form-control" placeholder="Voltase"></div></div></div>';
            }else{
