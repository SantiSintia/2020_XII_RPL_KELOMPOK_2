  ...
  <div class="login-box card">
    <div class="card-body">
      <form class="form-horizontal form-material" id="loginform" action="https://www.wrappixel.com/demos/admin-templates/material-pro/minisidebar/index.html">
        ...
        <img src="{{URL::to('assets/images/logo-icon.png')}}" alt="Home" /><br/><img src="{{URL::to('assets/images/logo-text.png')}}" alt="Home" /></a> 
        ...
        <div class="form-group m-b-0">
          <div class="col-sm-12 text-center">
            Already have an account? <a href="pages-login-2.html" class="text-info m-l-5"><b>Sign In</b></a>
          </div>
        </div>
      </form>
    </div>
