...
class CreateAssetCategoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('asset_categories', function (Blueprint $table) {
            ...
            $table->string('asc_code')->unique();
            $table->string('asc_original_code');
            $table->string('asc_name');
            $table->unsignedBigInteger('asc_parent_asset_categories_id')->nullable();
            ...
            $table->foreign('asc_parent_asset_categories_id')->references('asc_id')->on('asset_categories')->onDelete('cascade');           
